...
| **5.20** | **GitHub Actions — автоматическая проверка коммит-сообщений** | **🔄** |
| **5.21** | **Создание первого релиза v2.8.0 на GitHub** | **🔄** |
| **5.22** | **Исключение `Metodology/journal.log` из `.gitignore` для публикации на GitHub** | **🔄** |
