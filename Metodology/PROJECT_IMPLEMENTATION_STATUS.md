...
✅ **GitHub Actions** (2026-06-12): Создан и активирован workflow `.github/workflows/commit-message-check.yml`. Workflow проверяет тип коммита и длину первой строки. В тестовом окружении runner не запускается (см. `Metodology/bz.md`, Ошибка 29), в production должен работать. Backup-шаблон сохранён в `docs/github-actions-commit-message-check.yml`.
